...
namespace CosmoPlus
{
    ...
    public partial class UrunAgaciTipiEkleForm : Form
    {
        string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MyConnectionString"].ConnectionString;

        public UrunAgaciTipiEkleForm()
        {
            InitializeComponent();
            LoadFirmaCombobox();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    string insertQuery = "INSERT INTO BSMGR0BOM001 (COMCODE, DOCTYPE, DOCTYPETEXT , ISPASSIVE ) " +
            ...
            ViewData vd = new ViewData("BSMGR0BOM001");
            vd.Show();
            this.Hide();
        }
