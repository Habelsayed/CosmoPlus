...
namespace CosmoPlus
{
    public partial class OperasyonTipiEkleForm : Form
    {
        string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MyConnectionString"].ConnectionString;

        public OperasyonTipiEkleForm()
        {
            InitializeComponent();
            LoadFirmaCombobox();
        }
        ...
        {
            // Kullanıcı seçimleri ve girişleri alınıyor
            ...
            // Eğer COMTEXT seçilmişse, COMCODE'u veritabanından al
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string insertQuery = "INSERT INTO BSMGR0OPR001 (COMCODE, DOCTYPE, DOCTYPETEXT, ISPASSIVE) " +
                                         "VALUES (@COMCODE, @DOCTYPE, @DOCTYPETEXT, @ISPASSIVE)";

                    SqlCommand insertCommand = new SqlCommand(insertQuery, connection);

                    // COMCODE parametresi null ise NULL olarak gönderilir
                    ...
                    {
                        MessageBox.Show("Operasyon eklenemedi!", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch (Exception ex)
                {
        ...
        ViewData vd = new ViewData("BSMGR0OPR001");
            vd.Show();
            this.Hide();
        }
